...
type Balance struct {
	...
	IsAboveThreshold     float32  `protobuf:"fixed32,4,opt,name=isAboveThreshold,proto3" json:"isAboveThreshold,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Balance) GetIsAboveThreshold() float32 {
	if m != nil {
...
var fileDescriptor_c2d647de60f1ae88 = []byte{
	...
	0x45, 0x82, 0x05, 0xac, 0x04, 0x43, 0x5c, 0xe9, 0x0e, 0x23, 0x17, 0x1f, 0xd4, 0x17, 0x6e, 0x39,
	0x89, 0xe9, 0xe9, 0xa9, 0x45, 0x64, 0x39, 0x46, 0x87, 0x4b, 0x10, 0x14, 0x3c, 0xe1, 0x99, 0x79,
	0x29, 0xf9, 0xe5, 0x4e, 0x28, 0xce, 0xc2, 0x94, 0xc0, 0xe9, 0x40, 0x0e, 0x4c, 0x07, 0x0a, 0xd9,
	0x70, 0x71, 0x87, 0x64, 0xe6, 0xa6, 0xba, 0x56, 0x14, 0x64, 0x16, 0xa5, 0xa6, 0x48, 0xb0, 0x2a,
	0x30, 0x6a, 0x70, 0x1b, 0x49, 0xe9, 0x41, 0x22, 0x47, 0x0f, 0x16, 0x39, 0x7a, 0x21, 0xb0, 0xc8,
	0x09, 0x42, 0x56, 0x9e, 0xc4, 0x06, 0x56, 0x60, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x5f, 0xbf,
	0x89, 0x03, 0xdc, 0x01, 0x00, 0x00,
}
